...
//
//
//class FollowingRecyclerViewAdapter(private val dataSet: ArrayList<Follower>, val clickCallback:(Int) ->Unit) : RecyclerView.Adapter<FollowerFollowingRecyclerViewAdapter.ViewHolder>(),  ProfilePageContract.View {
