...
class SkillsOtherProfileAdapter(private val data: ArrayList<String>, private val context: Context) :

    RecyclerView.Adapter<SkillsOtherProfileAdapter.SkillsViewHolder>() {
