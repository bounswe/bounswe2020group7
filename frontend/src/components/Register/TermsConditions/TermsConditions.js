...
export default function CustomizedDialogs() {
  ...
  return (
    <div>
      <StyledLink variant="outlined" color="primary" onClick={handleClickOpen}>
      ...
      >
        ...
        <DialogContent dividers>
          <Typography gutterBottom>
            ...
            <p>Welcome to Platon!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Platon's Website.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use platon if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing platon, you agreed to
              use cookies in agreement with the Platon's Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, Platon and/or its licensors own the
              intellectual property rights for all material on platon. All
              intellectual property rights are reserved. You may access this
              from platon for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from platon</li>
              <li>Sell, rent or sub-license material from platon</li>
              <li>Reproduce, duplicate or copy material from platon</li>
              <li>Redistribute content from platon</li>
            </ul>
            ...
            <p>
              ...
              Platon does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of Platon,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, Platon
            ...
            <p>
              Platon reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Platon a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              Platon; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Platon. Please include your name, your
            ...
            <p>
              No use of Platon's logo or other artwork will be allowed for
